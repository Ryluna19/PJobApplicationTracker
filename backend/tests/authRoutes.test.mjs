...
// Simula o PostgreSQL para os testes não usarem o banco real.
...
beforeEach(() => {
    ...
    // Evita exibir erros simulados de banco no terminal.
...
describe("POST /register", () => {
    ...
    it("returns 500 when the database fails while registering", async () => {
...
describe("POST /login", () => {
    ...
    it("returns 500 when the database fails while logging in", async () => {
        fakePool.query.mockRejectedValueOnce(
            new Error("Database connection failed")
        );
